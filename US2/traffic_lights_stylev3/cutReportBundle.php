...
$orderID = $_REQUEST['orderID'];
 ...
 //   $cutID = '511';
  ...
  $sectionID = $row['sectionID'];
    $result = sqlsrv_query($conn,"SELECT * from traffic.cutreport_bundleStatus where orderID='$orderID' and cutID='$cutID' and sectionID='$sectionID' ORDER BY cast(bundleID as int) ASC");
         if($result)
         {
          $output["error"] = false;
